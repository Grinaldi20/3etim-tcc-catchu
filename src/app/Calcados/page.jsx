    ...
    <div className="main">
      ...
      <main className={styles.main}>
        <div className={styles.centro}>
          <h1 className={styles.h1}>Calcados</h1>
        </div>
            ...
            <div className={styles.footerBrand}>
              ...
              <div>
                <p className={styles.footerTag}>
                  Encontre e reserve itens perdidos
                </p>
              ...
              >
                ...
                {menuVisible && (
                  ...
                  >
                    ...
                    <a
                      href="https://wa.me/5514998963943"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      Thiago
                    ...
                    <a
                      href="https://wa.me/5514999078399"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      Pedro
                    ...
                    <a
                      href="https://wa.me/5514991069085"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      Caiani
