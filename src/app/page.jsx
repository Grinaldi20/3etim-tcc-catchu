        ...
        <div id="carouselExampleIndicators" className="carousel slide" data-bs-ride="carousel">
          ...
          <div className="carousel-inner" style={{ height: "400px" }}>
            <div className="carousel-item active">
              <Image className={`d-block w-100 ${styles.imagem}`} src="/carrosel2.png" alt="Slide 1" width={1200} height={400} quality={100} />
            </div>
            <div className="carousel-item">
              <Image className={`d-block w-100 ${styles.imagem}`} src="/carrosel6.png" alt="Slide 2" width={1200} height={400} quality={100} />
            </div>
            <div className="carousel-item">
              <Image className={`d-block w-100 ${styles.imagem}`} src="/carrosel.png" alt="Slide 3" width={1200} height={400} quality={100} />
            </div>
          </div>
