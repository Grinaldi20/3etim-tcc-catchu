    ...
    <div>
     <header className={styles.header}>
        ...
        <div className={styles.Icons}>
            ...
            <a href="CONFIGURAÇÃO/configuracao.html">
...
<div id="carouselExampleIndicators" className={`carousel slide ${styles.carroselSlide}`} data-bs-ride="carousel">
  <div className={styles.carroselIndicators}>
    <button
      type="button"
  ...
  <div className={styles.carroselInner}>
    <div  className={styles.carroselItemActive}>
      <Image
        className={`d-block w-100 ${styles.imagem}`}
        src="/carrosel2.png"
        alt="Carrosel 1"
        width={200}
        height={150}
  ...
  <button
     className={styles.carroseControlPrev}
    type="button"
    data-bs-target="#carouselExampleIndicators"
    data-bs-slide="prev"
  >
    <span
      className={`carousel-control-prev-icon ${styles.carroselControlPrevIcon}`}
      aria-hidden="true"
    ></span>
  ...
  <button
   className={styles.carroselControlNext}
    type="button"
    data-bs-target="#carouselExampleIndicators"
    data-bs-slide="next"
  >
    <span
      className={`carousel-control-next-icon ${styles.carroselControlNextIcon}`}
      aria-hidden="true"
    ></span>
