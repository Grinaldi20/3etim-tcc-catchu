...
export default function Categorias() {
    ...
    <main>
        <h1>Categorias</h1>
        <div class="CardsCarrocel">
            <a href="MaterialEscolar.html">
        ...
        <div class="CardsItens">
            <div class="Cards">
                <img src="bolsa.png" alt="">
                <p>Blusa Azul</p>
                <button onclick="abrirModal()">Saber Mais</button>
            </div>

            <div class="Cards">
                <img src="CamisaPreta.jpg" alt="">
                <p>Camisa Preta</p>
                <button>Saber Mais</button>
            </div>

            <div class="Cards">
                <img src="Chave.jpg" alt="">
                <p>Chave</p>
                <button>Saber Mais</button>
            </div>
        ...
        <div id="modal" class="modal">
            <div class="modal-content">
              ...
              <h2>Bulsa Azul</h2>
              <img src="BlusaAzul.png" alt="Bolsa preta">
